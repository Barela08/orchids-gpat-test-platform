...
export default function AdminPage() {
  ...
  const formatTime = (seconds: number) => {
    ...
    const parseQuestions = (text: string, year: string) => {
        ...
        // Split by Q followed by number pattern (Q1, Q2, etc.) or just number followed by dot
        ...
        for (const block of blocks) {
          ...
          for (const line of lines) {
            // Check for question line (Q1. or 1.)
            ...
            // Check for answer line (✅ Answer: C or Answer: C)
            const answerMatch = line.match(/(?:✅\s*)?Answer:\s*([A-Da-d])(?:[\.\)]?\s*(.*))?/i);
            if (answerMatch) {
              correctAnswer = answerMatch[1].toLowerCase() as "a" | "b" | "c" | "d";
              continue;
            }
            ...
            // If we have question text and this line doesn't match patterns, append to question
            if (questionText && !line.match(/^[A-Da-d][\.\)]/i)) {
              questionText += " " + line;
            }
          }
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <TabsContent value="results">
            <Card className="bg-white/10 backdrop-blur border-white/20">
              <CardHeader>
                <CardTitle className="text-white">All Student Results</CardTitle>
              </CardHeader>
              <CardContent>
                {results.length === 0 ? (
          ...
          <TabsContent value="students">
            ...
            <TabsContent value="upload">
              <Card className="bg-white/10 backdrop-blur border-white/20">
                <CardHeader>
                  <CardTitle className="text-white">Upload Questions</CardTitle>
                </CardHeader>
